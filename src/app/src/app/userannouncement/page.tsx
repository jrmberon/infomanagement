    ...
    <span
      ...
      <svg
        ...
        <path
          ...
          <div className="square h-56 mb-90  border-100   px-4 lg:px-20 py-5 shadow-2xl ">
           <div className=" archives  mr - 40 "> 
          
           <h1> <u> Archives </u> </h1>
          <div className="button">
        <button className = "font-sm absolute right-640  font-sans bg-blue-500  text-white text-center flex items-center px-3  rounded font-bold   ">
